...
def build_model(input_shape, activation, type):
    x=Input(shape=input_shape)
    if(type == 'LSTM'):
        attention_layer = LSTM(50, return_sequences=True, activation=activation)(x)
        attention_layer = attention()(LSTM_layer)
    elif(type == 'GRU'):
        attention_layer = GRU(50, return_sequences=True, activation=activation)(x)

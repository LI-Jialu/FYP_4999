...
# Label(backtestwin, bg="white", text='Prediction accuracy').place(x=200, y = 10)

'''path = './180_timestamp.png'
#Creates a Tkinter-compatible photo image, which can be used everywhere Tkinter expects an image object.
img2 = ImageTk.PhotoImage(Image.open(path).resize((480,320), Image.ANTIALIAS))
#The Label widget is a standard Tkinter widget used to display a text or image on the screen.
Label(backtestwin, bg="white", text='Image of backtesting').place(x=800, y = 10)
tk.Label(backtestwin, bg="white", image = img2).place(x=800,y=30)'''

...
Label(master, bg="white", text='Image of the predicted change v.s. true change').place(x=200, y = 10)
Label(master, bg="white", image = img1).place(x=80,y=30)
Label(master, bg="white", text='MSE = ').place(x=250, y = 370)
Label(master, bg="white", text='573.4').place(x=350, y = 370)
Label(master, bg="white", text='R squared = ').place(x=250, y = 400)
Label(master, bg="white", text='0.80').place(x=350, y = 400)
